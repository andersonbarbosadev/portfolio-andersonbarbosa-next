  ...
  return (
    <div className="group relative flex h-fit w-full cursor-text flex-col items-center justify-center overflow-hidden rounded-lg border border-[#1a1443] bg-[linear-gradient(90deg,#281e57_0%,#201435_100%)] px-3 py-[1.4rem] shadow-2xl md:px-8">
      ...
      <div className="flex h-full w-full flex-col items-center justify-between">
        <h2 className="text-center text-[1.525rem] leading-[110%] font-semibold text-[#EFF3F4] capitalize not-italic">
          {name}
        </h2>
        <div className="p-6">
          <Image
        ...
        <div className="flex w-full items-center justify-between">
          ...
          <Link
            href={code}
            target="_blank"
            className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border-2 border-[#EFF3F4] text-[#EFF3F4] no-underline transition-all delay-[0.3s] duration-300 group-hover:translate-x-[-140px] hover:scale-110 hover:border-[#0F0C41] hover:bg-[#231d4b] hover:text-violet-600"
          >
            <FaCode />
          </Link>
        </div>
      </div>
      <p className="absolute top-0 left-0 w-[90%] translate-x-[-110%] translate-y-[25%] rounded-[0_20px_20px_0] bg-[#0f0b24] p-6 text-xs leading-[110%] text-[#EFF3F4] transition-transform duration-[0.9s] group-hover:translate-x-[-2%] md:min-h-[150px] md:w-[85%] md:translate-y-[50%] md:text-sm">
        {description}
      </p>
      <div className="absolute right-0 bottom-4 flex w-[140px] translate-x-full flex-col justify-center gap-2 rounded-[10px_0_0_10px] bg-[#0f0b24] p-[0.825rem] text-[0.8rem] text-[#EFF3F4] transition-transform delay-[0.3s] duration-[0.5s] group-hover:translate-x-0">
        {tags.map((tag, id) => (
